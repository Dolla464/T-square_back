...
<body>
    ...
    <div class="filters-row">
        <span class="filter-chip"><span class="chip-label">Student:</span>{{ $payload['full_name'] ?? '—' }}</span>
        <span class="filter-chip"><span class="chip-label">Email:</span>{{ $payload['email'] ?? '—' }}</span>
