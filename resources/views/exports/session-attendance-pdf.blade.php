...
<body>
    ...
    <div class="filters-row">
        ...
        <span class="filter-chip"><span class="chip-label">Date:</span>{{ $payload['session_date'] ?? '—' }}</span>
        <span class="filter-chip"><span class="chip-label">Time:</span>{{ $payload['start_time'] ?? '—' }} -
            {{ $payload['end_time'] ?? '—' }}</span>
        <span class="filter-chip"><span class="chip-label">Status:</span>{{ $payload['status'] ?? '—' }}</span>
    </div>
